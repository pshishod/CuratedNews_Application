...
//
//Displays the view for a single news article
import SwiftUI
    ...
    var body: some View {
        ...
        ZStack{
            ...
            HStack{
                ...
                VStack(spacing: 0){
                    //Expandable list (tentative to change)
                    DisclosureGroup(
                        //Display the title
                        new.title!
                    ){
                        //Display the rest of the title (tentative to change)
                        Text(new.title!)
                ...
                .frame(width:.infinity, height: 150, alignment: .topLeading) //Try to make pretty
                
                
            }.padding(4)
            
        }.clipShape(RoundedRectangle(cornerRadius: 15))
        .shadow(color: Color.flatDarkCardBackground, radius: 5, x: 5, y:5) //Try to make pretty
